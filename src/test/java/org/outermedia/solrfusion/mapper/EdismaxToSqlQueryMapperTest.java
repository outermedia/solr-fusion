 ...
 */
public class EdismaxToSqlQueryMapperTest
{
    ...
    public void testSimpleQueryMapping() throws FileNotFoundException, ParserConfigurationException, SAXException, JAXBException, InvocationTargetException, IllegalAccessException
    {
        ...
        QueryBuilderIfc qb = getEdismaxToMysqlQb();
    ...
    private QueryBuilderIfc getEdismaxToMysqlQb() throws InvocationTargetException, IllegalAccessException
    {
        return searchServerConfig.getQueryBuilder(cfg.getDefaultQueryBuilder());
    }
    ...
    public void testAllDocsQueryHandling() throws FileNotFoundException, ParserConfigurationException, SAXException, JAXBException, InvocationTargetException, IllegalAccessException
    {
        ...
        Assert.assertEquals("Expected match all docs query", "1=1", s);
    }
    ...
    public void testFuzzyQuery() throws InvocationTargetException, IllegalAccessException
    {
        ...
        Assert.assertEquals("Expected match all docs query",
                "`dbatest`.`de_sball_model_PersonIfc`.`username` sounds like 'abc'", s);
    }
    ...
    public void testWildcardQuery() throws InvocationTargetException, IllegalAccessException
    {
        ...
        QueryBuilderIfc qb = getEdismaxToMysqlQb();
        String s = buildQueryString(qb, pq, cfg, searchServerConfig, locale, null, QueryTarget.ALL);
        Assert.assertEquals("Expected match wildcard query",
                "`dbatest`.`de_sball_model_PersonIfc`.`username` like 'a%bc%'", s);
    }
    ...
    public void testRangeQueries() throws InvocationTargetException, IllegalAccessException
    {
        ...
        String expectedSql[] =
                {"(`dbatest`.`de_sball_model_PersonIfc`.`birthday` >= '2014-06-26 00:00:00' AND `dbatest`.`de_sball_model_PersonIfc`.`birthday` <= '2014-07-01 00:00:00')",
                        "(`dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` >= 2.5 AND `dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` <= 4.5)",
                        "(`dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` >= 2.5 AND `dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` <= 4.5)",
                        "(`dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` >= 2 AND `dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` <= 4)",
                        "(`dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` >= 2 AND `dbatest`.`de_sball_model_PersonIfc`.`failLoginNr` <= 4)"};
        int at = 0;
    ...
    public void testBoolQuery() throws InvocationTargetException, IllegalAccessException
    {
        ...
        String s = buildQueryString(getEdismaxToMysqlQb(), bq, cfg, searchServerConfig, locale, null, QueryTarget.ALL);
        ...
        s = buildQueryString(getEdismaxToMysqlQb(), bq, cfg, searchServerConfig, locale, null, QueryTarget.ALL);
        ...
        Assert.assertEquals("Other sql than expected",
                "(!(`dbatest`.`de_sball_model_PersonIfc`.`username` like '%abc%') " +
                        ...
                        "AND `dbatest`.`de_sball_model_PersonIfc`.`username` like '%ghi%' OR `dbatest`.`de_sball_model_PersonIfc`.`username` like '%jkl%' OR true)",
                s);
    ...
    public void testSubQuery() throws InvocationTargetException, IllegalAccessException
    {
        ...
        Assert.assertEquals("Expected other mapping", "dbatest.de_sball_model_PersonIfc.username^1.1 dbatest.de_sball_model_PersonIfc.name^2.1", mappedParams.get("qf"));

        String s = buildQueryString(getEdismaxToMysqlQb(), sq, cfg, searchServerConfig, locale, null, QueryTarget.ALL);
        Assert.assertEquals("Other sql than expected","(`dbatest`.`de_sball_model_PersonIfc`.`username` like 'abc%')",s);
    }
